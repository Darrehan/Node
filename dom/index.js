...
function displayContent(items) {
  ...
  //appending the child element in the div of tab content
}
...
function highlightButton(btn) {
  ...
  btn.className = "active"; // set new style / highlights
}
// it will trigger an event. event is also a kind of javascript varialble object
function handleClick(event) {
  // getting corresponding button id .
...
displayContent(content[0]); // initially show this content on the screen 
